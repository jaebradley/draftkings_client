...
from draft_kings.output.objects.contests import DraftGroup, EntriesDetails, Contest, ContestsDetails
...
class DraftGroupTransformer:
    ...
    def transform(self, draft_group_response: ResponseDraftGroup) -> DraftGroup:
        return DraftGroup(
...
class ContestTransformer:
    ...
    def transform(self, contest_response: ResponseContest) -> Contest:
        return Contest(
